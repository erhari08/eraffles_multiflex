...
@section('subtitle', 'Folding')
@section('content_header_title', 'Folding')
        ...
        <div class="card card-primary card-outline shadow-sm" style="border-top: 5px solid #462A75;">
            <div class="card-body overflow-auto">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="mb-0 fw-bold text-dark">📑 Folding Management</h5>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content shadow">
                <div class="modal-header  text-white" style="background-color:#462A75">
                    <h5 class="modal-title fw-semibold" id="exampleModalLabel">📝 Create Folding</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                                ...
                                <tbody id="reportBody">
                                    <tr>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][plain_roll_no]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][film_size]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][gross_weight_plain]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][core_weight_plain]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][net_returned_plain]"></td>

                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][pearl_roll_no]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][pearl_size]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][gross_weight_pearl]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][core_weight_pearl]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][consumed_weight]"></td>

                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][output_roll_no]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][gross_weight_output]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][core_weight_output]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][net_weight_output]"></td>
                                        <td><input type="text" class="form-control form-control-sm"
                                                name="roll[0][wastage]"></td>
                                    </tr>
                                </tbody>
                            </table>
                            <button type="button" id="addRowBtn" class="btn btn-outline-primary btn-sm">➕ Add
                                Row</button>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" form="inspectionForm" class="btn text-white"
