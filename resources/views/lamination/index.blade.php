...
@section('subtitle', 'Lamination')
@section('content_header_title', 'Lamination')
        ...
        <div class="card card-primary card-outline shadow-sm" style="border-top: 5px solid #462A75;">
            <div class="card-body overflow-auto">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="mb-0 fw-bold text-dark">📑 Lamination Management</h5>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content shadow">
                <div class="modal-header  text-white" style="background-color:#462A75">
                    <h5 class="modal-title fw-semibold" id="exampleModalLabel">📝 Create Lamination</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="submit" form="laminationForm" class="btn text-white"
