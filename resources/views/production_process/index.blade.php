...
@section('content_body')
  ...
  <div class="text-center mb-4">
    <img src="https://cdn-icons-png.flaticon.com/512/4712/4712035.png" width="80" class="mb-2" alt="Logo">
  ...
  <ul class="nav nav-tabs justify-content-center" id="processTabs" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link active" id="printing-tab" data-bs-toggle="tab" data-bs-target="#printing" type="button" role="tab">
    ...
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="lamination-tab" data-bs-toggle="tab" data-bs-target="#lamination" type="button" role="tab">
        <i class="fas fa-layer-group text-warning"></i> Lamination
        <span class="badge bg-warning text-dark ms-1">⏳</span>
      </button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="slitting-tab" data-bs-toggle="tab" data-bs-target="#slitting" type="button" role="tab">
        <i class="fas fa-cut text-secondary"></i> Slitting
        <span class="badge bg-secondary ms-1">⏺</span>
      </button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="folding-tab" data-bs-toggle="tab" data-bs-target="#folding" type="button" role="tab">
        <i class="fas fa-compress-arrows-alt text-secondary"></i> Folding
        <span class="badge bg-secondary ms-1">⏺</span>
      </button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="pouching-tab" data-bs-toggle="tab" data-bs-target="#pouching" type="button" role="tab">
