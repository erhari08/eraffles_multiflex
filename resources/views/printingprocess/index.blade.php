                ...
                <div class="container border rounded p-3 p-md-4">
                    ...
                    <div class="row g-3 mb-3 align-items-start">
                        ...
                        <div class="col-12 col-md-9">
                            <div class="p-3 mt-2"
                                style="min-height: 150px; border: 3px dotted #6c757d; border-radius: 10px; background-color: #fff;">
                                <!-- This is the letter content area. Replace or update this text as needed. -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <div>
                                ...
                                <input type="text" id="letter_shift" class="form-control" placeholder="Day / Night">
                            </div>
                        </div>
                    </div>
